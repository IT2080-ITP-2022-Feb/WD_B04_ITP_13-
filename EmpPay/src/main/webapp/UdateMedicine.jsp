    ...
    <section class="signin-wrapper min-vh-100 clearfix" style="background-image: url(images/signup.jpg);">
        <div class="form-block min-vh-100">
            <form action="save-medicine" method="POST">
            	...
            	<input type="text" name="username" placeholder="First Name.." value="${patient.username }">
            	<input type="text" name="Lastname" placeholder="Last Name.." value="${patient.Lastname }">
                <input type="text" name="phone" placeholder="patient Phone" value="${patient.phone }">
                 <input type="text" name="nic" placeholder="NIC Number" value="${patient.nic }">
                 <input type="text" name="bgroup" placeholder="Blood Group" value="${patient.bgroup }">
                 <input type="text" name="dname" placeholder="Doctor Name.." value="${patient.dname }">
                <br>

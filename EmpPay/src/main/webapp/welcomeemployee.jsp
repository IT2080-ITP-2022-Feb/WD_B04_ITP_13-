                ...
                <div class="main-navigation" id="main-nav-bar">
                    <ul class=" navigation-box">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="addNewMedi">Vehical Management</a>
                        </li>
                         <li>
                            <a href="addNewMedi">patient Word</a>
                        </li>
                    ...
                    <div class="container">
                        <div class="box valign-middle">
                            <div class="content text-left">
                                <h3 data-animation="animated fadeInUp">Payroll <br> Management</h3>
            ...
            <div class="carousel-item slide-3" style="background-image: url(images/banner-1-3.jpg);">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="box valign-middle">
                            <div class="content text-left">
                                <h3 data-animation="animated fadeInUp">Payroll <br> Hospital Management</h3>
